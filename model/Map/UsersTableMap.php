...
class UsersTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Lastname', 'Password', 'LastLogin', 'Email', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'lastname', 'password', 'lastLogin', 'email', ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID, UsersTableMap::COL_NAME, UsersTableMap::COL_LASTNAME, UsersTableMap::COL_PASSWORD, UsersTableMap::COL_LAST_LOGIN, UsersTableMap::COL_EMAIL, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'lastname', 'password', 'last_login', 'email', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Lastname' => 2, 'Password' => 3, 'LastLogin' => 4, 'Email' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'lastname' => 2, 'password' => 3, 'lastLogin' => 4, 'email' => 5, ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID => 0, UsersTableMap::COL_NAME => 1, UsersTableMap::COL_LASTNAME => 2, UsersTableMap::COL_PASSWORD => 3, UsersTableMap::COL_LAST_LOGIN => 4, UsersTableMap::COL_EMAIL => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'lastname' => 2, 'password' => 3, 'last_login' => 4, 'email' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
